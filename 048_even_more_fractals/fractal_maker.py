...
# change is added to the turtle's current heading.
        ...
        # ADDED RANDOMNESS
        # 1/1 added tangent to randomness
        yCh = spec.get('yChange', 0.0)  * math.tan(random.randrange(-10, 10))
...
# Double Spiral Squares:
    ...
    {'sizeChange': 0.8, 'yChange': -0.1, 'angleChange': 10}], 11)
elif DRAW_FRACTAL == 4:
# Triangle Spiral:
